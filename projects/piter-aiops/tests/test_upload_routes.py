...
def test_upload_success_html(upload_client, upload_service):
    upload_service.next_result = UploadResult(
        filename="note.txt",
        s3_key="projects/incidentIQ-midproject/data/sample_documents/x_note.txt",
        s3_uri="s3://bucket/projects/incidentIQ-midproject/data/sample_documents/x_note.txt",
        size_bytes=12,
        sync_started=True,
