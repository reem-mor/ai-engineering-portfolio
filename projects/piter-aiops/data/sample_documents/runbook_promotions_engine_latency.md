...
1. Check promotions-engine cache hit ratio and `redis-cache` health (`runbook_redis_token_store.md`).
...
3. If a deploy regressed rule evaluation, roll back (`runbook_deployment_rollback.md`).
