...
- `auth-api` login errors rise (token store unavailable — see `runbook_auth_login.md` RB-002).
...
4. If a deploy caused unbounded key growth, roll it back (`runbook_deployment_rollback.md`).
