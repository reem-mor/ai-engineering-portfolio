...
|-------------|----------------|
| `07_app_homepage_public.png` | Full-page homepage (`localhost:8080` OK; rename note if not EC2) |
| `08_app_question_and_answer.png` | Auth triage question → `.badge-grounded` + `.citation-list` |
| `09_app_refusal_or_low_confidence.png` | Tokyo restaurant question → `.badge-nomatch` |
| `11_pytest_43_passed.png` | Rendered `py -3.12 -m pytest -v` output |
