# RB-009: Kafka Consumer Lag (settlement / analytics)
...
**Note:** For **email-worker queue lag**, use `runbook_queue_lag.md` — not this runbook.
...
4. If a deploy regressed processing throughput, roll back (`runbook_deployment_rollback.md`).
